  ...
  Shadow: {
    ...
    talents: {
      ...
      "Shadowform": {
        ...
        maxRank: 1, 
        reqPoints: 20, 
        description: talentText`Assume a Shadowform, increasing your Shadow damage by 15% and reducing Physical damage done to you by 20%.  However, you may not cast Holy spells while in this form.`, 
      },
